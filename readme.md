...
Antes de ejecutar el ETL o el dashboard, asegúrate de configurar las siguientes variables de entorno en tu sistema o en un archivo .env en la raíz del proyecto:
```bash
MYSQL_HOST=...
MYSQL_PORT=...
MYSQL_USER=...
